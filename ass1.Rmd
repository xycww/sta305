...
grid.arrange(tableGrob(x_var_summary), ageMarried_bar, literacy_bar, ncol = 3, 
             widths = c(1.5, 1.2,1.5),  # Adjust widths for all 3 columns
             top = textGrob("Figure 2: Statistical Summary and Distribution of Predictor Variables 'Age at marriage' and 'Literacy status'. \nThe table on the left summarizes the number of individuals in each category, showing that \n the majority of individuals marry between ages 20 to 25, with 1,126 marrying between 20 to 22 \n and 1,468 marrying between 22 to 25. Marriages before age 15 and after 30 are less common. \n The bar plot for 'Age Married' illustrates a slightly left-skewed distribution, peaking in the 22 to 25 category. \n The bar plot for ‘Literacy Status’ illustrates the proportion of literate and illiterate individuals, s\n showing that 4,567 out of 5,148 individuals in the dataset are literate.",
                            gp = gpar(fontsize = 10, fontface = "bold")))
...
kable(finalTable, digits = 3, caption = "Table: Log-rate ratios and 95% confidence intervals for the Negative Binomial model relating school institution type, region, and interactions to the number of violent crimes.")
```
